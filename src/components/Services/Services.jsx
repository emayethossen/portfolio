...
const Services = () => {
    return (
        <section className='container lg:w-4/5 mx-auto py-12'>
            <div className='mb-12'>
            ...
            <div className="">
                <div className="grid lg:grid-cols-3 gap-10 justify-center items-center">
                    <div className="bg-gray-200 dark:bg-slate-400 py-12 px-4 rounded-xl text-center service-style w-[228px] mx-auto h-[322px] shadow-xl">
